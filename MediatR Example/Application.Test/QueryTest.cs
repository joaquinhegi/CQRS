...
namespace Application.Test
{
    public class QueryTest
    {
        ...
        public async Task TestFindPersonBetweenYearCommandHandler()
        {
            ...
            var result = await handler.Handle(querybetweenPerson, CancellationToken.None);
        ...
        public async Task TestFindPersonByIdCommandHandler()
        {
            ...
            result.LastName.Should().Be("Gonzales");            
            result.DateOfBirth.Should().Be(20.February(1987));
        }
